...
export default function signIn() {
  ...
  return (
    <CustomKeyboardView>
      ...
      <View style={{paddingTop: hp(8), paddingHorizontal: wp(5)}} className="flex-1 dap-12">
        {/*signIn image */}
        ...
        <View className="gap-10">
          ...
          <View className="gap-4">
            ...
            {/* submit button */}
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', height: hp(6.5)}} className="bg-indigo-500 rounded-xl justify-center items-center pt-5">
              {
                loading? (
                  <View className="flex-row justify-center alignment-center" >
                    <Loading size={hp(6.5)}/>
                  </View>
                ):(
                  <TouchableOpacity onPress={handleLogin} style={{height: hp(6.5)}} className="bg-indigo-500 rounded-xl justify-center items-center">
                    <Text style={{fontSize: hp(2.7)}} className="text-black font-bold tracking-wider">Sign In</Text>
                  </TouchableOpacity>
                )
              }
            </View>
